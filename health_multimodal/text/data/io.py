...
class TextInput:
    ...
    def tokenize_input_prompts(self, prompts: TypePrompts, verbose: bool) -> Any:
        ...
        # `batch_encode_plus` is not available on the tokenizer object returned by
        # newer Transformers versions; calling the tokenizer directly is the
        # supported batched API and returns the same style of BatchEncoding.
